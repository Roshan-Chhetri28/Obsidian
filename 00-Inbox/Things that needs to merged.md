...
| fix/videoDeepLink        | Backend                                  | The Apps route changed which caused the deeplink to go obsolete and didnt open the video tab                 | No                                                 | Merged, Not checked |
| fix/whatsappPush         | Backend                                  | The Admin was getting notification for his own reply                                                         | No                                                 |                     |
| feat/videoDecoupling     | backend                                  | Soft delete Unnecessary notes and heading and Hading Removed while adding video                              | node database/migrations/removeUnnecessaryNotes.js |                     |
